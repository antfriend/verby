...
VAR
        ...
        word input[voices], angle[voices], depth[voices], params
...
PUB start(the_param_pointer) | i, r
    stop_signal := 1
    param_pointer := the_param_pointer
    repeat i from 0 to voices -1
      'each voice is not on a new cog, but each subsequent vocal tract is 
      input[i] := v[i].start(param_pointer) 'starts cogs 4,5,6,7 of 8
...
PRI Set_params_Value | da_params
   
    da_params := byte[param_pointer][THE_PARAMS_PARAM]
    'params :=  %NNN_XXX_PPP_DDD
    case da_params
      0..4 :
        params :=  %000_000_000_000
      5..9 :
        params :=  %001_011_001_001
      10..29 :
        params :=  %001_011_010_010
      30..59 :
        params :=  %001_011_010_011
      60..99 :
        params :=  %001_011_100_100
      100..160 :
        params :=  %001_010_101_101
      161..249 :
        params :=  %001_011_110_110
      250..257 :
        params :=  %001_100_111_111
